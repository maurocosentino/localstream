// src/api/ApiRouter.ipp
#pragma once

namespace localstream {

template<typename App>
crow::json::wvalue ApiRouter<App>::artistToJson(const Artist& artist)
{
...
template<typename App>
crow::json::wvalue ApiRouter<App>::albumToJson(const Album& album)
{
    crow::json::wvalue json;
    json["id"]        = album.id;
...
template<typename App>
crow::json::wvalue ApiRouter<App>::trackToJson(const Track& track)
{
    crow::json::wvalue json;
    json["id"]           = track.id;
...
template<typename App>
crow::json::wvalue ApiRouter<App>::playlistToJson(const Playlist& playlist)
{
    crow::json::wvalue json;
    json["id"]         = playlist.id;
...
template<typename App>
void ApiRouter<App>::setupRoutes()
{
